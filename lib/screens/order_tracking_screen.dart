          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Order #${order.id.substring(0, 6).toUpperCase()}',
                          style: TextStyle(color: AppColors.gold, fontWeight: FontWeight.w700, fontSize: 16.sp)),
                      4.verticalSpace,
                ...
                const Divider(),
                12.verticalSpace,
                Text('Items', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16.sp)),
                8.verticalSpace,
                ...order.items.map((item) => Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('${item['name']} × ${item['qty']}', style: TextStyle(fontSize: 14.sp)),
                          Text('₹${(item['price'] * item['qty']).toStringAsFixed(0)}', style: TextStyle(fontSize: 14.sp)),
                        ],
                      ),
                    )),
                const Divider(),
                Row(
                  ...
                  children: [
                    ...
                    Text('₹${order.total.toStringAsFixed(0)}',
                        style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.maroon, fontSize: 16.sp)),
                  ],
                ),
                16.verticalSpace,
                Text('Delivering to', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16.sp)),
                6.verticalSpace,
                Text(order.deliveryAddress, style: TextStyle(color: AppColors.textDark.withValues(alpha: 0.7), fontSize: 13.sp)),
              ],
            ),
          );
        },
